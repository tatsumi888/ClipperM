...
- アーキテクチャ設計書(`architecture.md` / `03-architecture.md` 等) - 技術スタックの確認
- リポジトリ構造(`repository-structure.md` / `04-repository-structure.md` 等) - ディレクトリ構造の確認
...
**重要**: `docs/` に既存の開発ガイドラインがある場合(ファイル名は `development-guidelines.md`
でも `05-development-guidelines.md` でも構いません)、以下の優先順位に従ってください:
...
**更新時**: 既存ガイドラインの構造と内容を維持しながら、既存のファイル名のまま更新する

## 出力先

**まず `docs/` を一覧してください。** 同種のドキュメント(開発ガイドライン)が既にある場合は、
...
```
docs/05-development-guidelines.md
```
