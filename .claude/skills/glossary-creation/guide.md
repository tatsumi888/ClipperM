...
**説明**:
ステアリングファイルは `.steering/[YYYYMMDD]-[NN]-[task-name]/` ディレクトリに
...
**関連ドキュメント**:
- [アーキテクチャ設計書](./03-architecture.md#技術スタック)
- [開発ガイドライン](./05-development-guidelines.md#TypeScript規約)
...
**参考**: [開発ガイドライン](./05-development-guidelines.md#TDD)
```
...
**参考資料**:
- [アーキテクチャ設計書](./03-architecture.md)
- [リポジトリ構造定義書](./04-repository-structure.md)
```
